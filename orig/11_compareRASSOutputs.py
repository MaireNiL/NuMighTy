		...
		for b in range(0,len(lines2_split)):
			...
			if line1_brk_ch1==line2_brk_ch1 and line1_brk_ch2==line2_brk_ch2:
				if not(line1_brk_str1==line2_brk_str1 and line1_brk_str2==line2_brk_str2):
					continue
				if  ((line1_brk_pos1 -  (min(line2_brk_start1,line2_brk_stop1) - 30) ) * (line1_brk_pos1-( max(line2_brk_start1, line2_brk_stop1)+30)) < 0 ) and  ((line1_brk_pos2 -  (min(line2_brk_start2,line2_brk_stop2) - 30) ) * (lin
e1_brk_pos2-( max(line2_brk_start2, line2_brk_stop2)+30)) < 0 )  :   #30bp range, overlap
					is_J_match=1
					break
				...
				if not(line1_brk_str1_revcomp==line2_brk_str1 and line1_brk_str2_revcomp==line2_brk_str2):
					continue
				if  ((line1_brk_pos1_revcomp -  (min(line2_brk_start1,line2_brk_stop1) - 30) ) * (line1_brk_pos1_revcomp-( max(line2_brk_start1, line2_brk_stop1)+30)) < 0 ) and  ((line1_brk_pos2_revcomp -  (min(line2_brk_start2,line2_b
rk_stop2) - 30) ) * (line1_brk_pos2_revcomp-( max(line2_brk_start2, line2_brk_stop2)+30)) < 0 )  :   #30bp range, overlap
					is_J_match=1
					break
			else: # not match
				continue
